 ...
 */
package com.lianzhu.modules.sys.db;

import com.lianzhu.modules.sys.entity.*;
import com.lianzhu.modules.sys.service.*;
...
import com.lianzhu.modules.sys.entity.CompanyOffice;
	...
	private void initGenTableColumn(GenTable genTable){
		for(GenTableColumn column : genTable.getColumnList()){
			if ("test_input".equals(column.getColumnName())
				...
				column.setAttrType("com.lianzhu.modules.sys.entity.Office");
