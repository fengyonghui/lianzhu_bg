 ...
 */
package com.baimeng.modules.sys.db;

import com.baimeng.modules.sys.entity.*;
import com.baimeng.modules.sys.service.*;
...
import com.baimeng.modules.sys.entity.Area;
...
import com.baimeng.modules.sys.entity.Employee;
import com.baimeng.modules.sys.entity.EmployeePost;
	...
	private void initGenTableColumn(GenTable genTable){
		for(GenTableColumn column : genTable.getColumnList()){
			if ("test_input".equals(column.getColumnName())
				...
				column.setAttrType("com.baimeng.modules.sys.entity.Office");
